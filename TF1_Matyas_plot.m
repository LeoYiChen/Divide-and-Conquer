...
% /*M-FILE SCRIPT TF1_Matyas_plot MMM SwarmsLAB */ %
% /*==================================================================================================
...
YYdata = TF1_Matyas( XXdata1 , XXdata2 );
...
%% save figures
saveas(gcf,'TF1_Matyas', 'pdf');
saveas(gcf,'TF1_Matyas', 'jpg');
saveas(gcf,'TF1_Matyas', 'eps');
saveas(gcf,'TF1_Matyas', 'fig');
