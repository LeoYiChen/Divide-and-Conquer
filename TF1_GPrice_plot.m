...
% /*M-FILE SCRIPT TF1_GPrice_plot MMM SwarmsLAB */ %
% /*==================================================================================================
...
YYdata = TF1_GPrice( XXdata1 , XXdata2 );
...
%% save figures
saveas(gcf,'TF1_GPrice', 'pdf');
saveas(gcf,'TF1_GPrice', 'jpg');
saveas(gcf,'TF1_GPrice', 'eps');
saveas(gcf,'TF1_GPrice', 'fig');
