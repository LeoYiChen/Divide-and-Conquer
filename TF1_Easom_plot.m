...
% /*M-FILE SCRIPT TF1_Easom_plot MMM SwarmsLAB */ %
% /*==================================================================================================
...
YYdata = TF1_Easom( XXdata1 , XXdata2 );
...
%% save figures
saveas(gcf,'TF1_Easom', 'pdf');
saveas(gcf,'TF1_Easom', 'jpg');
saveas(gcf,'TF1_Easom', 'eps');
saveas(gcf,'TF1_Easom', 'fig');
