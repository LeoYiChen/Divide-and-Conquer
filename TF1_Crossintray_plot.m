...
% /*M-FILE SCRIPT TF1_Crossintray_plot MMM SwarmsLAB */ %
% /*==================================================================================================
...
YYdata = TF1_Crossintray( XXdata1 , XXdata2 );
...
%% save figures
saveas(gcf,'TF1_Crossintray', 'pdf');
saveas(gcf,'TF1_Crossintray', 'jpg');
saveas(gcf,'TF1_Crossintray', 'eps');
saveas(gcf,'TF1_Crossintray', 'fig');

toc
% TF1_Crossintray_plot End