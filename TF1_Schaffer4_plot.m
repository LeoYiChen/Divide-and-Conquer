% function [  ] = TF1_Schaffer4_plot()

% /*M-FILE SCRIPT TF1_Schaffer4_plot MMM SGALAB */ %
% /*==================================================================================================
%  Simple Genetic Algorithm Laboratory Toolbox for Matlab 7.x
% ====================================================================================================
%File description:
% to plot Shaffer's F4 function to test SGALAB's performance
%  -100 < x < 100
%  -100 < y <100
%Appendix comments:
...
[ schafferValue ] = TF1_Schaffer4( XX , YY );
...
% COLORBAR('vert');
% toc
% TF1_Schaffer4_plot End

%% save figures
saveas(gcf,'TF1_Schaffer4', 'pdf');
saveas(gcf,'TF1_Schaffer4', 'jpg');
saveas(gcf,'TF1_Schaffer4', 'eps');
saveas(gcf,'TF1_Schaffer4', 'fig');
