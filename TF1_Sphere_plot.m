...
% /*M-FILE SCRIPT TF1_Sphere_plot MMM SwarmsLAB */ %
% /*==================================================================================================
...
for ind = 1 : 1: datalength
    for jnd =  1 : 1: datalength
        ...
        YYdata(ind,jnd) = TF1_Sphere([XXdata1(ind,jnd),XXdata2(ind,jnd)]);
...
%% save figures
saveas(gcf,'TF1_Sphere', 'pdf');
saveas(gcf,'TF1_Sphere', 'jpg');
saveas(gcf,'TF1_Sphere', 'eps');
saveas(gcf,'TF1_Sphere', 'fig');
