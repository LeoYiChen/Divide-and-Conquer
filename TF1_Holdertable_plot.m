...
% /*M-FILE SCRIPT TF1_Holdertable_plot MMM SwarmsLAB */ %
% /*==================================================================================================
...
YYdata = TF1_Holdertable( XXdata1 , XXdata2 );
...
%% save figures
saveas(gcf,'TF1_Holdertable', 'pdf');
saveas(gcf,'TF1_Holdertable', 'jpg');
saveas(gcf,'TF1_Holdertable', 'eps');
saveas(gcf,'TF1_Holdertable', 'fig');

toc
% TF1_Holdertable_plot End