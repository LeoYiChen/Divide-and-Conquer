...
% /*M-FILE SCRIPT TF1_McCormick_plot MMM SwarmsLAB */ %
% /*==================================================================================================
...
YYdata = TF1_McCormick( XXdata1 , XXdata2 );
...
%% save figures
saveas(gcf,'TF1_McCormick', 'pdf');
saveas(gcf,'TF1_McCormick', 'jpg');
saveas(gcf,'TF1_McCormick', 'eps');
saveas(gcf,'TF1_McCormick', 'fig');

toc
% TF1_McCormick_plot End